...
def dtype_to_ctype(dtype: type) -> type: return getattr(dtype, "__metadata__")[0]

def ast_of_function(f: typing.Callable[..., typing.Any]) -> ast.FunctionDef: return typing.cast(ast.FunctionDef, ast.parse(textwrap.dedent(inspect.getsource(f))).body[0])
